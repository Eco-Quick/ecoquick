  ...
  return (
    <div className="landing-shell min-h-screen bg-white text-[#3e0074] antialiased dark:bg-[#0d0916] dark:text-[#c084fc]">
      ...
      <main className="pt-12 md:pt-16">
        {/* Hero */}
        <section className="pb-12 px-6 md:px-10 md:pb-16">
          <div className="mx-auto max-w-6xl">
            <h1 className="satoshi-thin mb-6 text-5xl leading-[0.9] uppercase md:mb-8 md:text-7xl lg:text-8xl">
              Redefining
              <br />
              <span className="md:pl-16">The Pulse</span>
              <br />
              Of The City
            </h1>
            <p className="max-w-xl text-base font-light leading-relaxed text-[#3e0074]/80 dark:text-[#c084fc]/80 md:text-lg">
        ...
        {/* Mission */}
        <section className="border-y border-[#3e0074]/5 bg-[rgba(62,0,116,0.05)] py-16 px-6 md:px-10 md:py-24 dark:border-[#4c1d95]/20 dark:bg-[rgba(192,132,252,0.05)]">
        ...
        <section className="py-16 px-6 md:px-10 md:py-24">
          <div className="mx-auto max-w-6xl">
            <div className="mb-12 flex flex-col items-start justify-between border-b border-[#3e0074]/10 dark:border-[#4c1d95]/20 pb-8 md:mb-16 md:flex-row md:items-end">
            ...
            <div className="grid gap-6 md:grid-cols-12">
              {[
                ...
                <div
                  key={step.k}
                  className="group col-span-12 border-l border-[#3e0074]/10 dark:border-[#4c1d95]/20 py-8 pl-6 sm:col-span-6 lg:col-span-3"
                >
        ...
        {/* Values */}
        <section className="bg-[#fafafa] dark:bg-[#0d0916] py-16 px-6 md:px-10 md:py-24">
          <div className="mx-auto max-w-6xl">
            <div className="grid items-start gap-10 md:grid-cols-12">
              ...
              <div className="col-span-12 lg:col-span-8">
                ...
                <div className="mb-8 border border-[#3e0074]/10 dark:border-[#4c1d95]/20 bg-white dark:bg-[#161027] p-10 text-[#3e0074] dark:text-[#c084fc] md:p-12">
                ...
                {/* Base 2x2 grid */}
                <div className="grid border border-[#3e0074]/10 dark:border-[#4c1d95]/20 bg-[#3e0074]/10 dark:bg-[#4c1d95]/20 md:grid-cols-2 gap-px">
                  {[
                    {
            ...
            <div className="grid gap-10 md:grid-cols-12">
              <div className="relative z-10 col-span-12 lg:col-span-6">
                ...
                <div className="relative space-y-16 md:space-y-20">
                  <div className="absolute left-0 top-0 bottom-0 w-px bg-[#3e0074]/10 dark:bg-[#4c1d95]/20" />

                  <div className="relative pl-10 md:pl-16">
                    <div className="absolute left-0 top-2 h-px w-4 bg-[#3e0074] dark:bg-[#c084fc]" />
                    ...
                    <p className="max-w-md text-base font-light leading-relaxed text-[#3e0074]/70 dark:text-[#c084fc]/70">
              ...
              <div className="relative hidden h-[600px] lg:col-span-6 lg:block">
                <div className="relative h-full w-full">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-r from-white via-transparent to-transparent dark:from-[#0d0916]" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="px-6 py-16 md:px-10 md:py-24">
          <div className="mx-auto min-h-[50vh] max-w-6xl border border-[#3e0074]/5 dark:border-[#4c1d95]/20 bg-[rgba(62,0,116,0.05)] dark:bg-[rgba(192,132,252,0.05)] p-12 md:p-24 lg:p-32">
            <div className="relative z-10 w-full">
              <div className="grid items-center gap-10 md:grid-cols-12">
                ...
                <div className="relative col-span-12 flex flex-col gap-4 sm:flex-row lg:col-span-5 lg:flex-col">
                  <Link
                    href="/signup"
                    className="sharp-corners ml-6 flex-1 border border-[#3e0074] dark:border-[#c084fc] bg-[#3e0074] dark:bg-[#c084fc] px-8 py-5 text-[10px] font-bold uppercase tracking-[0.25em] text-white dark:text-[#0d0916] transition-all hover:bg-black dark:hover:bg-[#a855f7] sm:ml-10"
                  >
                    Book your first delivery
                  </Link>
                  <Link
                    href="/signup?profile=driver"
                    className="sharp-corners flex-1 border border-[#3e0074] dark:border-[#c084fc] px-8 py-5 text-[10px] font-bold uppercase tracking-[0.25em] text-[#3e0074] dark:text-[#c084fc] transition-all hover:bg-[#3e0074] hover:text-white dark:hover:bg-[#c084fc] dark:hover:text-[#0d0916]"
                  >
